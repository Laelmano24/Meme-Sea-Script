...
local Enemy_Location = workspace.Location.Enemy_Location
...
getgenv().RaelHubBringMobs = false
...
function CheckDistance()
 ...
 local humanoidrootpart = Character:FindFirstChild("HumanoidRootPart")
  local MonsterPart = Enemy_Location:FindFirstChild(getgenv().MonsterName)
...
function RaelHubMemeSea.BringMobs(value)
  
  getgenv().RaelHubBringMobs = value
  
  task.spawn(function()
    
    while getgenv().RaelHubBringMobs do
